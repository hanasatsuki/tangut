...
$resule_of_update = update($russian_serial, $meaning, $functionword, $verbaffix, $personword, $transliterate, $borrowword, $unknownword, $propername, $combineword, $notes, $original);
